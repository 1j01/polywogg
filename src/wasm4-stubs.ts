...
// @ts-ignore: decorator
@external("env", "blit")
export function blit(spritePtr: usize, x: i32, y: i32, width: u32, height: u32, flags: u32): void { return void (0); };

/** Copies a subregion within a larger sprite atlas to the framebuffer. */
// @ts-ignore: decorator
@external("env", "blitSub")
export function blitSub(spritePtr: usize, x: i32, y: i32, width: u32, height: u32,
	srcX: u32, srcY: u32, stride: i32, flags: u32): void { return void (0); };
...
// @ts-ignore: decorator
@external("env", "line")
export function line(x1: i32, y1: i32, x2: i32, y2: i32): void { return void (0); };

/** Draws a horizontal line. */
// @ts-ignore: decorator
@external("env", "hline")
export function hline(x: i32, y: i32, len: u32): void { return void (0); };

/** Draws a vertical line. */
// @ts-ignore: decorator
@external("env", "vline")
export function vline(x: i32, y: i32, len: u32): void { return void (0); };

/** Draws an oval (or circle). */
// @ts-ignore: decorator
@external("env", "oval")
export function oval(x: i32, y: i32, width: u32, height: u32): void { return void (0); };

/** Draws a rectangle. */
// @ts-ignore: decorator
@external("env", "rect")
export function rect(x: i32, y: i32, width: u32, height: u32): void { return void (0); };
...
function textUtf16(text: string, byteLength: u32, x: i32, y: i32): void { return void (0); };
...
// @ts-ignore: decorator
@external("env", "tone")
export function tone(frequency: u32, duration: u32, volume: u32, flags: u32): void { return void (0); };
...
// @ts-ignore: decorator
@external("env", "diskr")
export function diskr(dest: usize, size: u32): u32 { return u32(0); };

/** Writes up to `size` bytes from the pointer `srcPtr` into persistent storage. */
// @ts-ignore: decorator
@external("env", "diskw")
export function diskw(src: usize, size: u32): u32 { return u32(0); };
...
function traceUtf16(str: usize, byteLength: u32): void { return void (0); };
